Gem::Specification.new do |s|
  s.name = "zinfinit-actionwebservice"

  s.version = "2.3.4.2"
  s.date = "2010-04-02"

  s.summary = "Web service support for ActionController."

  s.author = ["Leon Breedt", "Kent Sibilev", "Matheus Paschoal"]
  s.email  = ["bitserf@gmail.com", "ksibilev@yahoo.com", "paschoal@gmail.com"]

  s.rubyforge_project = "zinfinit-actionwebservice"
  s.homepage = "http://github.com/zinfinit/actionwebservice"
